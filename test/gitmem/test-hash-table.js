...
GitConvert.stringToExistingArray($h, 0, 'abc');
...
GitConvert.arrayToExistingArray($h, 40, hashInBlock2);
GitConvert.arrayToExistingArray($h, 60, hashInBlock3);
GitConvert.arrayToExistingArray($h, 80, hashInNextBlock1);
